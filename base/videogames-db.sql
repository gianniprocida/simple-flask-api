...
CREATE TABLE platform (id INT PRIMARY KEY,platform_name VARCHAR(50));

CREATE TABLE genre (id INT PRIMARY KEY,genre_name VARCHAR(50));

CREATE TABLE publisher (id INT PRIMARY KEY,publisher_name VARCHAR(100));

CREATE TABLE region (id INT PRIMARY KEY,region_name VARCHAR(50));
